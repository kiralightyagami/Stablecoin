...
use crate::{Config, Collateral, CONFIG_SEED,burn_tokens , get_lamports_from_usd, withdraw_sol, calculate_health_factor};
...
pub fn liquidate(ctx: Context<Liquidate>, amount_to_burn: u64) -> Result<()> {
    ...
    withdraw_sol(
        ctx.accounts.collateral_account.sol_account_bump,
        &ctx.accounts.collateral_account.depositor_account,
